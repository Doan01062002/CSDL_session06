...
-- 1,
-- Tạo bảng Patients (Thông tin bệnh nhân)
...
-- Tạo bảng Doctors (Thông tin bác sĩ)
...
-- Tạo bảng Appointments (Lịch hẹn khám)
CREATE TABLE Appointments (
    AppointmentID INT AUTO_INCREMENT PRIMARY KEY,
    PatientID INT NOT NULL,
    DoctorID INT NOT NULL,
    AppointmentDate DATETIME NOT NULL,
    Status ENUM('Da Dat', 'Da Huy', 'Hoan Thanh') NOT NULL,
...
VALUES
    ...
    (3, 1, '2025-02-28 12:30:00', 'Da Dat'),  -- Sửa lỗi
...
SELECT 
    ...
    CASE 
        WHEN TIMESTAMPDIFF(YEAR, p.BirthDate, CURDATE()) < 18 THEN 'Trẻ em'
        WHEN TIMESTAMPDIFF(YEAR, p.BirthDate, CURDATE()) BETWEEN 18 AND 30 THEN 'Trung niên'
        WHEN TIMESTAMPDIFF(YEAR, p.BirthDate, CURDATE()) BETWEEN 31 AND 40 THEN 'Qua thời'
        WHEN TIMESTAMPDIFF(YEAR, p.BirthDate, CURDATE()) BETWEEN 41 AND 50 THEN 'Lớn tuổi'
        WHEN TIMESTAMPDIFF(YEAR, p.BirthDate, CURDATE()) BETWEEN 51 AND 60 THEN 'Già'
        ELSE 'Người cao tuổi'
    END AS AgeGroup
FROM Patients p
